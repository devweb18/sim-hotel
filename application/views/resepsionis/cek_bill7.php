...
<hr/>
  ...
  <button class="btn btn-default " type="submit">Simpan</button>
	...
	<?php 
			...
			///====================================================================REFUNT UPDATE
			if($totalall > 0){
			 	$this->Mhotel->okrefund($id_p,'ok');/////tbl_pesan_kamar
			}else{
...
<!---->
  		<div class="form-group">
		    <label for="">NOMINAL </label><br/>
		     <div class="input-group">
        <span class="input-group-addon">Rp :</span>
   <input type="number" min="0" name="nominal" placeholder="-" value="" class="form-control" required> 
      <span class="input-group-btn">
      </span>
    </div>
			    </div>
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="input-group">
  <span class="input-group-addon">Rp : </span>
  <input type="number" min="0" name="nominal" class="form-control" placeholder="-" id="inputEmail3">
</div>
    </div>
  </div>
 <div class="form-group">
