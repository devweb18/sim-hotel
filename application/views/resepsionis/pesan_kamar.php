...
<!--   <div class="alert alert-success alert-dismissable">
  ...
  <?=$this->session->flashdata('pesan')?>
      <form class="form-horizontal" role="form" method="post" action="<?=base_url()?>/C_resepsionis/simpan">
          <ul class="list-group">
  ...
  <div class="form-group">
   ...
   <input type="hidden" name="cekin" value="<?=$tanggal_reel?>">
   <input disabled type="text" placeholder="<?=date('d-m-Y')?>" value="<?=$tanggal_reel?>" class="form-control">
  ...
  foreach($jkol->result() as $kol){?>
  	...
  	<td>
  		...
  		<?php
  		$dd=$this->Mhotel->cek_kamar_no_dd($kol->id_jkamar);
