...
<hr/>
  <div class="form-group">
  <label for="">CASH MONEY </label><br/>
<div class="input-group">
        <span class="input-group-addon">Rp : </span>
  <input type="text" class="form-control" name="cas" placeholder="-" autofocus>
      <span class="input-group-btn">
      </span>
    </div><!-- /input-group -->
  ...
  <label for="">NON TUNAI  </label><br/>
<div class="input-group">
        <span class="input-group-addon">Rp : </span>
  <input type="text" class="form-control" name="cas_t" placeholder="-"   autofocus>
      <span class="input-group-btn">
  ...
  <button class="btn btn-default" type="submit">Simpan</button>
		...
		<td  align="right" rowspan="2" bgcolor="<?=$warna?>">
		<?php
		//revisi masterpra:
...
<div class="form-group">
 ...
 <div class="col-sm-5">
	...
	<?php	} ?>
		...
		$tot=($tot+$am->harga+$hh->harga_bed+$hh->harga_ot+$bg_kam)-$disc;
